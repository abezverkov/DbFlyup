...
namespace DbFlyup.SqlServer
{
    ...
    /// </summary>
    public class FlywaySqlScriptExecutor : ScriptExecutor
    {
        ...
        public FlywaySqlScriptExecutor(Func<IConnectionManager> connectionManagerFactory, Func<IUpgradeLog> log, string schema, Func<bool> variablesEnabled,
